...
url="https://drive.google.com/file/d/1cQCFzP_jc32l1ays2xI8sJO_yeH-zJbW/view?usp=sharing"

class Molecule_10(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        return tfds.core.DatasetInfo(
            builder=self,
            description="Chemistry Data with Top 10 Features",
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        data_path = gdown.download(
            url=url, output=os.path.join(dl_manager.download_dir, "molecule_10.pkl"), fuzzy=True 
        )
